...
namespace nilnul.interval
{
	...
	public partial class Interval4<T>
		:
		...
		//where T:IEquatable<T>
	{
		...
		#region ctor
		public Interval4(TotalOrderI3<T> order, Cut left, Cut right)
		{
		...
		public Interval4(StrictTotalOrderI<T> order, Cut left,Cut right)
		...
		public Interval4(TotalOrderI3<T> order)
		{
			this.order = order;
			set();
		}
