...
namespace nilnul.order.total.finite
{
	...
	public partial class ClopenInterval<T>
		:
		Interval<T>
		...
		//where T:IEquatable<T>
	{
		...
		#region ctor
		public ClopenInterval(nilnul.order.total.finite.OrderI<T> order,T left, T right)
			:base(order,new ClosedCut<T>( left), new OpenCut<T>(right))
		{
		...
		public ClopenInterval(nilnul.order.total.finite.StrictOrderI<T> order, T left,T right)
